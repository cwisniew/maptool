...
public record ElevationLevel(int level, String name) {

  public static ElevationLevel fromDto(ElevationDto.ElevationLevelDto dto) {
    return new ElevationLevel(dto.getLevel(), dto.getName());
  }
